...
* **Body:** None
![image alt](https://github.com/PraveenAulagar/spring-restful-banking-application/blob/8b1145ea653747bac4555206f716bfce97b5e210/spring_restFul_bankingApplication/screenshots/fetch_single_account_details.png)
### 3. Fetch All Accounts Details
* **HTTP Method:** GET
* **URL:** `http://localhost:8050/api/accounts`
* **Body:** None
![image alt](https://github.com/PraveenAulagar/spring-restful-banking-application/blob/e62ff021b525d684ce2f9398ee2dd7bb04245d7c/spring_restFul_bankingApplication/screenshots/fetch_all_account_details.png)
...
```
![image alt](https://github.com/PraveenAulagar/spring-restful-banking-application/blob/83837d3e36082b47632303b161aea85a16f05659/spring_restFul_bankingApplication/screenshots/deposit_amount.png)
### 2. Withdraw Funds
* **HTTP Method:** PUT
